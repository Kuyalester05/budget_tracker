...
class _EditTransactionScreenState extends State<EditTransactionScreen> {
  ...
  Future<void> _save() async {
    ...
    _showSnack('Transaction updated!', isError: false);
  }
  ...
  void _showSnack(String msg, {required bool isError}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(msg),
        backgroundColor: isError ? AppColors.expenseRed : AppColors.primaryGreen,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _typeButton('Income', '💰', TransactionType.income,
                        AppColors.incomeGradient),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: _typeButton('Expense', '💸', TransactionType.expense,
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow:
                                  isSelected ? AppColors.cardShadow : null,
                            ),
                            child: Row(
